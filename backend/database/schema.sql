...
(UUID(), 'auth.signInToAccount', 'en', 'Sign in to your account', 'auth', 'Login page subtitle'),
(UUID(), 'auth.signIn', 'en', 'Sign in', 'auth', 'Sign in button'),
(UUID(), 'auth.signingIn', 'en', 'Signing in...', 'auth', 'Sign in loading state'),
(UUID(), 'auth.noAccount', 'en', 'Don''t have an account? Sign up', 'auth', 'Link to register'),
(UUID(), 'auth.haveAccount', 'en', 'Already have an account? Sign in', 'auth', 'Link to login'),
(UUID(), 'auth.createAccount', 'en', 'Create your account', 'auth', 'Register page subtitle'),
(UUID(), 'auth.signUp', 'en', 'Sign up', 'auth', 'Sign up button'),
(UUID(), 'auth.creatingAccount', 'en', 'Creating account...', 'auth', 'Sign up loading state'),
(UUID(), 'auth.confirmPassword', 'en', 'Confirm Password', 'auth', 'Confirm password field'),
(UUID(), 'auth.welcome', 'en', 'Welcome to Aerocheck!', 'auth', 'Dashboard welcome message'),
(UUID(), 'auth.emailAddress', 'en', 'Email address', 'auth', 'Email address field label'),
(UUID(), 'auth.passwordMinChars', 'en', 'Password (min 6 characters)', 'auth', 'Password field with minimum length hint'),
(UUID(), 'auth.passwordsDoNotMatch', 'en', 'Passwords do not match', 'auth', 'Password mismatch validation error'),
(UUID(), 'auth.passwordMinLength', 'en', 'Password must be at least 6 characters', 'auth', 'Password minimum length validation error'),
(UUID(), 'auth.verificationEmailSent', 'en', 'We''ve sent a verification email to', 'auth', 'Email verification sent message'),
(UUID(), 'auth.verificationInstructions', 'en', 'Click the link in the email to verify your account. The link will expire in 24 hours.', 'auth', 'Email verification instructions'),
(UUID(), 'auth.goToLogin', 'en', 'Go to Login', 'auth', 'Button to navigate to login page'),
(UUID(), 'auth.checkSpam', 'en', 'Didn''t receive the email? Check your spam folder.', 'auth', 'Hint to check spam folder'),
(UUID(), 'auth.verifyEmailPrompt', 'en', 'Please verify your email address to access all features.', 'auth', 'Email verification prompt message'),
(UUID(), 'auth.verificationSent', 'en', 'Verification email sent! Check your inbox.', 'auth', 'Verification email sent success message'),
(UUID(), 'auth.resendFailed', 'en', 'Failed to resend email', 'auth', 'Resend email failure message'),
(UUID(), 'auth.resendError', 'en', 'Failed to resend email. Please try again.', 'auth', 'Resend email error message'),
(UUID(), 'auth.loggedInAs', 'en', 'You''re logged in as', 'auth', 'Logged in status message'),
(UUID(), 'auth.verified', 'en', 'Verified', 'auth', 'Email verified status'),
(UUID(), 'auth.notVerified', 'en', 'Not Verified', 'auth', 'Email not verified status'),
...
(UUID(), 'common.sending', 'en', 'Sending...', 'common', 'Sending state'),
(UUID(), 'common.userInformation', 'en', 'User Information', 'common', 'User information section title'),
(UUID(), 'common.id', 'en', 'ID', 'common', 'ID label'),
(UUID(), 'common.email', 'en', 'Email', 'common', 'Email label'),
(UUID(), 'common.name', 'en', 'Name', 'common', 'Name label'),
(UUID(), 'common.emailStatus', 'en', 'Email Status', 'common', 'Email status label'),
...
(UUID(), 'errors.connectionFailed', 'en', 'Failed to connect to server. Please try again.', 'errors', 'Connection failed error message');
...
(UUID(), 'auth.signInToAccount', 'nl', 'Inloggen op uw account', 'auth', 'Login pagina subtitel'),
(UUID(), 'auth.signIn', 'nl', 'Inloggen', 'auth', 'Inlog knop'),
(UUID(), 'auth.signingIn', 'nl', 'Inloggen...', 'auth', 'Inloggen laad status'),
(UUID(), 'auth.noAccount', 'nl', 'Nog geen account? Registreer', 'auth', 'Link naar registratie'),
(UUID(), 'auth.haveAccount', 'nl', 'Al een account? Inloggen', 'auth', 'Link naar login'),
(UUID(), 'auth.createAccount', 'nl', 'Maak uw account aan', 'auth', 'Registratie pagina subtitel'),
(UUID(), 'auth.signUp', 'nl', 'Registreren', 'auth', 'Registreer knop'),
(UUID(), 'auth.creatingAccount', 'nl', 'Account aanmaken...', 'auth', 'Registratie laad status'),
(UUID(), 'auth.confirmPassword', 'nl', 'Bevestig Wachtwoord', 'auth', 'Bevestig wachtwoord veld'),
(UUID(), 'auth.welcome', 'nl', 'Welkom bij Aerocheck!', 'auth', 'Dashboard welkom bericht'),
(UUID(), 'auth.emailAddress', 'nl', 'E-mailadres', 'auth', 'E-mailadres veld label'),
(UUID(), 'auth.passwordMinChars', 'nl', 'Wachtwoord (min. 6 tekens)', 'auth', 'Wachtwoord veld met minimum lengte hint'),
(UUID(), 'auth.passwordsDoNotMatch', 'nl', 'Wachtwoorden komen niet overeen', 'auth', 'Wachtwoord overeenkomst validatie fout'),
(UUID(), 'auth.passwordMinLength', 'nl', 'Wachtwoord moet minimaal 6 tekens bevatten', 'auth', 'Wachtwoord minimum lengte validatie fout'),
(UUID(), 'auth.verificationEmailSent', 'nl', 'We hebben een verificatie e-mail gestuurd naar', 'auth', 'E-mail verificatie verzonden bericht'),
(UUID(), 'auth.verificationInstructions', 'nl', 'Klik op de link in de e-mail om uw account te verifiëren. De link verloopt na 24 uur.', 'auth', 'E-mail verificatie instructies'),
(UUID(), 'auth.goToLogin', 'nl', 'Naar Inloggen', 'auth', 'Knop naar login pagina'),
(UUID(), 'auth.checkSpam', 'nl', 'E-mail niet ontvangen? Controleer uw spam map.', 'auth', 'Hint om spam map te controleren'),
(UUID(), 'auth.verifyEmailPrompt', 'nl', 'Verifieer uw e-mailadres om toegang te krijgen tot alle functies.', 'auth', 'E-mail verificatie prompt bericht'),
(UUID(), 'auth.verificationSent', 'nl', 'Verificatie e-mail verzonden! Controleer uw inbox.', 'auth', 'Verificatie e-mail verzonden succesbericht'),
(UUID(), 'auth.resendFailed', 'nl', 'E-mail opnieuw verzenden mislukt', 'auth', 'E-mail opnieuw verzenden foutbericht'),
(UUID(), 'auth.resendError', 'nl', 'E-mail opnieuw verzenden mislukt. Probeer het opnieuw.', 'auth', 'E-mail opnieuw verzenden fout'),
(UUID(), 'auth.loggedInAs', 'nl', 'U bent ingelogd als', 'auth', 'Ingelogd status bericht'),
(UUID(), 'auth.verified', 'nl', 'Geverifieerd', 'auth', 'E-mail geverifieerd status'),
(UUID(), 'auth.notVerified', 'nl', 'Niet Geverifieerd', 'auth', 'E-mail niet geverifieerd status'),
...
(UUID(), 'common.sending', 'nl', 'Versturen...', 'common', 'Versturen status'),
(UUID(), 'common.userInformation', 'nl', 'Gebruikersinformatie', 'common', 'Gebruikersinformatie sectie titel'),
(UUID(), 'common.id', 'nl', 'ID', 'common', 'ID label'),
(UUID(), 'common.email', 'nl', 'E-mail', 'common', 'E-mail label'),
(UUID(), 'common.name', 'nl', 'Naam', 'common', 'Naam label'),
(UUID(), 'common.emailStatus', 'nl', 'E-mail Status', 'common', 'E-mail status label'),
...
(UUID(), 'errors.network', 'nl', 'Netwerkfout. Probeer het opnieuw.', 'errors', 'Netwerkfout bericht'),
(UUID(), 'errors.unauthorized', 'nl', 'Niet geautoriseerd. Log opnieuw in.', 'errors', 'Niet geautoriseerd fout'),
(UUID(), 'errors.connectionFailed', 'nl', 'Kan geen verbinding maken met de server. Probeer het opnieuw.', 'errors', 'Verbinding mislukt foutbericht');
